...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	   ...
	   'buttons' => array(
	      ...
	      array(
            ...
            'fields' => array(
				...
				'contactus_boxbrdcolor',
				'contactus_box1btnbgcolor',
				'contactus_box3bgcolor'
		 ...
		 array(
		   ...
		   'icon' => 'dashicons dashicons-layout',
		   'fields' => array(
			   'star_hotel_contactus_section_width',
			   'star_hotel_contactus_padding',
			   'star_hotel_contactus_section_toppadding',
			   'star_hotel_contactus_section_bottompadding'
		   ),
		)
    ...
    $wp_customize->add_control(
        new starhotel_Toggle_Switch_Custom_Control(
            ...
            'contactus_disable_section',
            array(
                'settings'      => 'contactus_disable_section',
                'section'       => 'contactus_setting',
                'label'         => __( 'Disable Section', 'star-hotel' ),
                'on_off_label'  => array(
                    'on' => __( 'Yes', 'star-hotel' ),
	...
	// contactus brd color
	$contactusbrdcolor = esc_html__('#fff', 'star-hotel' );
	$wp_customize->add_setting(
    	'contactus_boxbrdcolor',
    	array(
			'default' => $contactusbrdcolor,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 4,
		)
	...
	// contactus 1btnbg color
	$contactus1btnbgcolor = esc_html__('#3c3e4e', 'star-hotel' );
	$wp_customize->add_setting(
    	'contactus_box1btnbgcolor',
    	array(
			'default' => $contactus1btnbgcolor,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 4,
		)
	...
	$wp_customize->add_control( 
		'contactus_box1btnbgcolor',
		array(
		    'label'   		=> __('Box 1 Button BG Color','star-hotel'),
		    'section'		=> 'contactus_setting',
			'type' 			=> 'color',
			'transport'         => $selective_refresh,
		)  
	...
	// contactus 3bg color
	$contactus3bgcolor = esc_html__('#01314b', 'star-hotel' );
	$wp_customize->add_setting(
    	'contactus_box3bgcolor',
    	array(
			'default' => $contactus3bgcolor,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 4,
		)
	...
	$wp_customize->add_control( 
		'contactus_box3bgcolor',
		array(
		    'label'   		=> __('Box 3 BG Color','star-hotel'),
		    'section'		=> 'contactus_setting',
			'type' 			=> 'color',
			'transport'         => $selective_refresh,
		)  
	...
	// layout setting
	$wp_customize->add_setting('star_hotel_contactus_section_width',array(
        'default' => 'Full Width',
        'sanitize_callback' => 'starhotel_sanitize_choices',
    ));
    $wp_customize->add_control('star_hotel_contactus_section_width',array(
        'type' => 'select',
        'label' => __('Section Width','star-hotel'),
        'choices' => array (
            'Box Width' => __('Box Width','star-hotel'),
	...
	$wp_customize->add_setting('star_hotel_contactus_padding',array(
		'sanitize_callback'   => 'esc_html'
	));
	$wp_customize->add_control('star_hotel_contactus_padding',array(
		'label' => __('Section padding','star-hotel'),
		'section' => 'contactus_setting'
	));

	$wp_customize->add_setting('star_hotel_contactus_section_toppadding',array(
		'default' => '2',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('star_hotel_contactus_section_toppadding',array(
		'type' => 'number',
		'label' => __('Top','star-hotel'),
		'section' => 'contactus_setting',
	));

	$wp_customize->add_setting('star_hotel_contactus_section_bottompadding',array(
		'default' => '2',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('star_hotel_contactus_section_bottompadding',array(
		'type' => 'number',
		'label' => __('Bottom','star-hotel'),
		'section' => 'contactus_setting',
	));
	...
	$wp_customize->add_control(new starhotel_Tab_Control($wp_customize, 'starhotel_blog_tabs', array(
	   ...
	   'buttons' => array(
		 ...
		 array(
		   ...
		   'icon' => 'dashicons dashicons-layout',
		   'fields' => array(
			   'star_hotel_blog_section_width',
			   'star_hotel_blog_padding',
			   'star_hotel_blog_section_toppadding',
			   'star_hotel_blog_section_bottompadding'
		   ),
		)
	...
	// layout setting
	$wp_customize->add_setting('star_hotel_blog_section_width',array(
        'default' => 'Box Width',
        'sanitize_callback' => 'starhotel_sanitize_choices',
    ));
    $wp_customize->add_control('star_hotel_blog_section_width',array(
        'type' => 'select',
        'label' => __('Section Width','star-hotel'),
        'choices' => array (
            'Box Width' => __('Box Width','star-hotel'),
	...
	$wp_customize->add_setting('star_hotel_blog_padding',array(
		'sanitize_callback'   => 'esc_html'
	));
	$wp_customize->add_control('star_hotel_blog_padding',array(
		'label' => __('Section padding','star-hotel'),
		'section' => 'blog_setting'
	));

	$wp_customize->add_setting('star_hotel_blog_section_toppadding',array(
		'default' => '4',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('star_hotel_blog_section_toppadding',array(
		'type' => 'number',
		'label' => __('Top','star-hotel'),
		'section' => 'blog_setting',
	));

	$wp_customize->add_setting('star_hotel_blog_section_bottompadding',array(
		'default' => '4',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('star_hotel_blog_section_bottompadding',array(
		'type' => 'number',
		'label' => __('Bottom','star-hotel'),
		'section' => 'blog_setting',
	));
