...
function starhotel_header_style() {
	$header_text_color = get_header_textcolor();
  	...
  	$contactus_disable_section = esc_attr(get_theme_mod('contactus_disable_section','YES'));
	...
	<style type="text/css">
		...
		.header-section .h-cont li a {
			color: <?php echo esc_attr(get_theme_mod('header_addressphonenocolor')); ?>;
		}

		.header-section .h-cont li a:hover {
			color: <?php echo esc_attr(get_theme_mod('header_addressphonenohovercolor')); ?>;
		}
		...
		.header-section .social-icons a:hover {
			color: <?php echo esc_attr(get_theme_mod('header_socialiconhvrcolor')); ?>;
		}

		.header-section .links li a{
			color: <?php echo esc_attr(get_theme_mod('header_loginregistercolor')); ?>;
		}

		.header-section .links li a:hover{
			color: <?php echo esc_attr(get_theme_mod('header_loginregisterhrvcolor')); ?>;
		}
		...
		#contactus-section .box2, #contactus-section .box1 h3::before,
		#contactus-section .box1 h3::after, #contactus-section .box3{
			border-color: <?php echo esc_attr(get_theme_mod('contactus_boxbrdcolor')); ?> !important;
		}

		#contactus-section .box1 .box1booknow {
			background-color: <?php echo esc_attr(get_theme_mod('contactus_box1btnbgcolor')); ?> !important;
		}

		#contactus-section .box3 {
			background: <?php echo esc_attr(get_theme_mod('contactus_box3bgcolor')); ?> !important;
		}

		#contactus-section {
			padding-top: <?php echo esc_attr(get_theme_mod('star_hotel_contactus_section_toppadding')); ?>em !important;
			padding-bottom: <?php echo esc_attr(get_theme_mod('star_hotel_contactus_section_bottompadding')); ?>em !important;
		}
		...
		.blog-area {
			padding-top: <?php echo esc_attr(get_theme_mod('star_hotel_blog_section_toppadding')); ?>em !important;
			padding-bottom: <?php echo esc_attr(get_theme_mod('star_hotel_blog_section_bottompadding')); ?>em !important;
		}
	...
	<?php
        if ($contactus_disable_section == 1):
	?>
		#contactus-section {
			display: none;
		}
